...
func (r *CloudSecretResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	// perform the request
	cresp, err := client.CreateCloudSecret(ctx, &pb.CreateCloudSecretRequest{TargetPve: r.kubesprayInventory.TargetPve, SecretName: data.SecretName.ValueString(), SecretData: data.SecretData.ValueString()})
	if err != nil {
...
func (r *CloudSecretResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	// perform the request
	cresp, err := client.DeleteCloudSecret(ctx, &pb.DeleteCloudSecretRequest{TargetPve: r.kubesprayInventory.TargetPve, SecretName: data.SecretName.ValueString()})
	if err != nil {
